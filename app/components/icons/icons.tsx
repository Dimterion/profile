...
export function GithubIcon({ className = "h-4 w-4 md:h-5 md:w-5" }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3.3 0 6.8-1.6 6.8-7A5.4 5.4 0 0 0 19.4 4 5 5 0 0 0 19.3.5S17.7 0 15 1.8a13.4 13.4 0 0 0-6 0C6.3 0 4.7.5 4.7.5A5 5 0 0 0 4.6 4a5.4 5.4 0 0 0-1.4 3.5c0 5.4 3.5 7 6.8 7a4.8 4.8 0 0 0-1 3.5v4" />
